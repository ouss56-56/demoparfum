...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 pt-8 pb-20">
            <div className="max-w-xl w-full">
                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/50">
                    ...
                    <div className="space-y-4">
                        <button
                            type="button"
                            onClick={() => alert(t("social_login_coming_soon"))}
                            className="w-full bg-white border border-gray-100 text-gray-400 py-4 rounded-2xl font-bold flex items-center justify-center gap-3 cursor-not-allowed"
                        >
                            <svg className="w-5 h-5 opacity-50" viewBox="0 0 24 24">
                                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#D1D5DB" />
                                ...
                                <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.16H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.84l3.66-2.75z" fill="#D1D5DB" />
                                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.16l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#D1D5DB" />
                            </svg>
